        ...
        <Dialog.Panel className='fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-background px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-border'>
          ...
          <div className='mt-6 flow-root'>
            <div className='-my-6 divide-y divide-border'>
              ...
              <div className='py-6'>
                <a href='/auth/login' className='-mx-3 block rounded-lg px-3 py-2.5 text-base leading-7 hover:bg-secondary'>
                  Log in
                </a>
                <a href='/auth/login?tab=register' className='-mx-3 mt-2 block rounded-lg px-3 py-2.5 text-base leading-7 hover:bg-secondary'>
                  Sign Up
                </a>
              </div>
            </div>
