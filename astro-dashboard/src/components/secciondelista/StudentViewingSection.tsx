...
const StudentViewingSection: React.FC = () => {
  return (
    <Box className="secciondl-light">
      <Box className="secciondl-wrapper">
        <Stack direction="row" justifyContent="space-between" alignItems="center" className="secciondl-header">
          <Typography variant="h6" fontWeight={700}>Student are viewing</Typography>
...
export default StudentViewingSection;
